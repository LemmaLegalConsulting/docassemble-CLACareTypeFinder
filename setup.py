...
setup(name='docassemble.CLACareTypeFinder',
      ...
      author='Jenny Haggard',
      author_email='jenny.haggard@savvysuit.com',
      ...
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/CLACareTypeFinder/', package='docassemble.CLACareTypeFinder'),
     )
